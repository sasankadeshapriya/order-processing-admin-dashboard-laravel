...
class ClientController extends Controller
{
    ...
    public function submitClient(Request $request)
    {
        ...
        try {
            ...
            $clientResponse = Http::post(env('API_URL') . '/client', $validatedData);
    ...
    public function editClientForm($id)
    {
        try {
            ...
            $clientResponse = Http::get(env('API_URL') . "/client/{$id}");
            ...
            $routesResponse = Http::get(env('API_URL') . '/route');
    ...
    public function updateClient(Request $request, $id)
    {
        ...
        $response = Http::put(env('API_URL') . "/client/{$id}", $data);
    ...
    public function toggleClientStatus(Request $request, $id)
    {
        ...
        try {
            ...
            $response = Http::post(env('API_URL') . "/client/verify/{$id}", [
                'status' => $status
            ]);
    ...
    {
        try {
            $response = Http::delete(env('API_URL') . "/client/$id");
