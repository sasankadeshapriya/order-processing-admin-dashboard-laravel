...
class PaymentController extends Controller
{
    ...
    {
        try {
            $responsePayments = Http::get(env('API_URL') . '/payment');
            $responseInvoices = Http::get(env('API_URL') . '/invoice');
            $responseClients = Http::get(env('API_URL') . '/client');
    ...
    public function togglePaymentState(Request $request, $id)
    {
        ...
        try {
            ...
            $url = env('API_URL') . "/payment/{$id}/state";
    ...
    {
        try {
            $response = Http::delete(env('API_URL') . "/payment/$id");
